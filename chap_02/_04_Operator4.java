...
public class _04_Operator4 {
    public static void main(String[] args) {
        ...
        System.out.println(김치찌개 || 계란말이 || 제육볶음); // 하나라도 true 이면 true (괜찮은 식당), or
        System.out.println(김치찌개 && 계란말이 && 제육볶음); // 모두 true 이면 true (최고의 식당), and
        ...
        // System.out.println(1 < 3 < 5); // 불가능한 코드 -> System.out.println(1 < 5 && 3 < 5); 가능한 코드
