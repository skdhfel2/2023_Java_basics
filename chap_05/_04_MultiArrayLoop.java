...
public class _04_MultiArrayLoop {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < seats3.length; i++) { // 세로, seats.length는 10이된다.
            for (int j = 0; j < seats3[i].length; j++) { // 열이 15이니까 0번쨰 행의 열도 15가된다.
        ...
        // 영화관 좌석 번호 확인
        for (int i = 0; i < seats3.length; i++) { // 세로, 0~9
            for (int j = 0; j < seats3[i].length; j++) { // 가로, 0~14
