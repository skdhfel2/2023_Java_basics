...
public class _03_ClassVariables {
    public static void main(String[] args) {
        ...
        System.out.println(b1.modelName + " 자동 신고 기능 : " + b1.canAutoReport); // (객체.변수)
        System.out.println(b2.modelName + " 자동 신고 기능 : " + b2.canAutoReport); // (객체.변수)
        System.out.println("모든 블랙박스 제품 자동 신고 기능 : " + BlackBox.canAutoReport); // 권장,(클래스.변수)
    }
}
