...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수 : " + random.nextInt()); // int 의 범위 내에서 무작위 정수값 반환
        ...
        // System.out.println("랜덤 실수 (범위) : " + random.nextDouble(10.0)); // Double은 값을 못넣는다.

        // 만약 5.0 이상 10.0 미만의 실수를 뽑으려면?
        double min = 5.0;
        double max = 10.0;
        System.out.println("랜덤 실수 (범위) : " + (min + (max - min) * random.nextDouble()));
        // 5 + (5) * random = 5 + 0이상 5.0 미만의 실수값 = 5이상 10.0 미만의 실수값
